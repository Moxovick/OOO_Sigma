(function($) {
  ...
  $(document).ready(function() {
    ...
    $(imgSelector).each(function() {
	  ...
	  if ($('.kc-carousel-image .item-grid a')) { // Make sure not to add to woocommerce product images
        $('.kc-carousel-image .item-grid a').removeClass('wfml-single'); //remove a class
      }
